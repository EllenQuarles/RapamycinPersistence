...
data_file <- "EQ4_6 20160827 upd sky post 0_1_2 only single columns ONLY OLD comps_no std in EQ6 order2.txt" #<- edit here

#B) Replace "ipa file.txt" with the name of the file containing the pathways and proteins for the heatmap
ipa_file <- "20160827 EQ4_6 heart prot IPA paths q05  canonical_pathways_forheatmap_bypathlength Mito OxPhos.txt"
title <- "EQ4_6 Male RP 16wk_Young"
